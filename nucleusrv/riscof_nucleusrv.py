...
class nucleusrv(pluginTemplate):
    __model__ = "nucleusrv"
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for nucleusrv start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
        ...
        # name of the elf is kept a variable to be fixed in the runTests function.
            ...
            # shutil.copy('test.disass', new_destination_file)
            # obj = shutil.copy("test.disass", new_destination_file)
